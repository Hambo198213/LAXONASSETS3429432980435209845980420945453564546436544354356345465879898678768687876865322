    ...
    if (filesByChar[char].length > 0) {
      filesByChar[char].forEach((file) => {
        ...
        btn.onclick = () => {
          ...
          fetch(
            `https://raw.githubusercontent.com/Hambo198213/LAXONASSETS3429432980435209845980420945453564546436544354356345465879898678768687876865322/main/Laxon_Assets/${encoded}`,
          )
